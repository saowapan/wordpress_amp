...
<form method="GET" action="land-see.amp.html" target="_top" class="p0 m0 px3 mb4">
  <fieldset class="border-none p0 m0">
    <h2 class="land-see-subs-heading-text">Weekly inspiration from <span class="bold">{{ get_bloginfo('name', 'display') }}</span></h2>
  ...
  <amp-img alt="A view of the sea, see?" class="land-see-subscribe-bg cover" layout="fixed-height" height="679" src="https://ampstart-iframes.firebaseapp.com/img/land-see/content/khatam-tadayon-107740.jpg">
...
<nav class="ampstart-footer-nav">
  <ul class="list-reset flex flex-wrap mb3">
    <li class="px1"><a class="text-decoration-none ampstart-label" href="#">Services</a></li>
    <li class="px1"><a class="text-decoration-none ampstart-label" href="#">Window Prices</a></li>
